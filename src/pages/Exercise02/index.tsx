...
export default function Exercise02() {
  ...
  const { movies, loading, fetchCount, handleMovieFetch } = useMovie(genderSelected, yearOrder);
  const { genders } = useGender();

  const updateMovies = (gender: any, order: any) => {
  ...
  return (
    <section className="movie-library">
      ...
      <Filter genders={genders} yearOrder={yearOrder} updateGender={updateGender} updateYearOrder={updateYearOrder} />
